export const skiFAQ_IT = {
  ...
  questions: {
    'Dove si trovano gli ski box?': {
      ...
      tags: ['ski box', 'attrezzatura', 'deposito', 'posizione', 'dove stanno gli ski box?', 'dove trovo gli ski box?', 'dove si trovano gli armadietti?']
    },
    'Come funzionano gli ski box?': {
      ...
      tags: ['ski box', 'funzionamento', 'riscaldamento', 'come funzionano gli ski box?', 'come si usano gli armadietti?', 'uso degli ski box?']
    },
    'Gli ski box sono riscaldati?': {
      ...
      tags: ['ski box', 'riscaldamento', 'asciugatura', 'ski box riscaldati?', 'gli armadietti sono riscaldati?', 'c\'è riscaldamento per gli sci?']
    },
    'Dove posso lasciare gli sci?': {
      ...
      tags: ['deposito', 'ski box', 'attrezzatura', 'dove lasciare gli sci?', 'dove mettere gli sci?', 'deposito sci?']
    },
    'Dove posso noleggiare l\'attrezzatura da sci?': {
      ...
      tags: ['noleggio', 'sci', 'snowboard', 'attrezzatura', 'sconto', 'dove noleggiare sci?', 'dove si affitta attrezzatura?']
    },
    'Ci sono scuole di sci disponibili?': {
      ...
      tags: ['scuola sci', 'lezioni', 'maestri', 'imparare', 'principianti', 'dove sono le scuole di sci?', 'posso prenotare lezioni sci?']
    },
    'È possibile acquistare lo skipass in hotel?': {
      ...
      tags: ['skipass', 'piste', 'acquisto', 'posso comprare skipass in hotel?', 'dove compro skipass?', 'acquisto skipass hotel?']
    },
    'Ci sono piste illuminate per lo sci notturno?': {
      ...
      tags: ['sci notturno', 'piste illuminate', 'orari', 'quando c\'è lo sci notturno?', 'ci sono piste notturne?', 'posso sciare di notte?']
    }
  }
};
